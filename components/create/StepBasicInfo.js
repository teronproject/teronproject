 ...
 */
export default function StepBasicInfo({ register, errors, setValue, isAssistanceMode }) {
  return (
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            <button
              ...
              className="text-xs px-2.5 py-1 rounded bg-surface-secondary border border-border-secondary text-text-secondary hover:bg-surface-tertiary hover:text-text-primary transition-colors disabled:opacity-50"
            >
              18 (Standard)
            </button>
            <button
