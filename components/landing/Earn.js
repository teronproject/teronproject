    ...
    <section className="relative w-full overflow-hidden border-t border-white/5 py-20 bg-[#050403]">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
           {/* Card 1: Referrals */}
           <div className="card rounded-3xl p-8 lg:p-10 flex flex-col gap-6 backdrop-blur-2xl bg-[#0a0a0a]/70 border border-white/10 shadow-[0_30px_60px_rgba(0,0,0,0.5)] relative overflow-hidden group transition-transform hover:-translate-y-1 duration-300">
             ...
             <div className="mt-auto pt-6 flex items-center">
                <Link href="/dashboard/referrals" className="text-[14px] font-semibold text-white flex items-center hover:text-accent transition-colors">
