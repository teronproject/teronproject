      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose-legal">
            ...
            <h2 className="text-xl font-medium text-white mb-4 tracking-tight">3. Converting Rewards</h2>
            <p className="text-text-secondary leading-relaxed mb-4">
              The swap interface allows you to seamlessly convert your earned reward tokens (such as TERR) into mainnet TER tokens or other supported assets once they become available.
            </p>
            <p className="text-text-secondary leading-relaxed mb-10">
            ...
            <h2 className="text-xl font-medium text-white mb-4 tracking-tight">4. Transaction Security</h2>
            <p className="text-text-secondary leading-relaxed mb-10">
