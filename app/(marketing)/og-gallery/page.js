...
export default function OGGalleryPage() {
  return (
    <div className="min-h-screen pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-[1200px] mx-auto">
      <div className="mb-16">
            ...
            <div key={route.path} className="flex flex-col gap-6">
              <div className="flex items-center justify-between border-b border-border-primary pb-4">
                ...
                <a
                  ...
                  className="text-sm text-accent hover:text-accent-hover transition-colors font-medium flex items-center gap-2 bg-accent/10 px-4 py-2 rounded-lg"
                >
                  View Full Size ↗
                </a>
              </div>
